...
import { UPDT_AVANC_USUR } from '../../BdMongoConf/graphql-operations'
import { useMutation } from '@apollo/client'
import { ListaUnProy,UnAvancesUser } from '../../BdMongoConf/configBD';


export const UpGenInsc = () => {
    ...
    // console.log(aportes);
    // MODIFICA UN AVANCE 
    const [modfAvance] = useMutation(UPDT_AVANC_USUR);
    const modificaAvance = async (e) => {
        e.preventDefault();
